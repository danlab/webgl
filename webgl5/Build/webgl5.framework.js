...
var ASM_CONSTS = {
  4312752: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 4312807: ($0) => { performance.now = function() { return $0; }; },  
 4312855: ($0) => { performance.now = function() { return $0; }; },  
 4312903: () => { performance.now = Module['emscripten_get_now_backup']; }
};
